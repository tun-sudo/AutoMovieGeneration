...
For example, the original prompt was "a man sunbathing on the beach, with the man's appearance referenced from image 0 and the beach background referenced from image 1," but the generated image had dim lighting, which did not match the concept of sunbathing. The revised prompt should include the original content and add a description of the lighting, such as: "a man sunbathing on the beach under bright lighting. The man's appearance is referenced from image 0, and the beach background is referenced from image 1."
"""
